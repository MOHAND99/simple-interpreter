...
public:
    AssignmentStatement(string statement); // The constructor will set the variableName and the valueExpression.
    ...
    void execute(unordered_map<string, double> *variables);
